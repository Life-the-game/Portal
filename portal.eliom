...
let _ =
  Example.register ~service:group
    (fun () () ->
      let url = "http://life.db0.fr/page/team.php?more"
      and url_edit = "https://docs.google.com/spreadsheet/ccc"
	^ "?key=0Ag8n0yHMUHF-dDJPS1RuLUdYUlc1WFYwMUlRaGJ0X0E#" in
	...
	[div ~a:[a_class ["alert"; "alert-info"]]
	    [pcdata "You can edit your information ";
	     Tools.external_link url_edit [pcdata "on Google Drive"];
	     pcdata "."];
	 great_iframe url])
...
let _ =
  Example.register ~service:faq
	...
	^ "1q5Ou3VAwzpNi6IhZrHSvClYkSgCNgWv6WQhmY7SIjtQ/pub" in
	...
	li [Tools.external_link url [pcdata txt]] in
	 ...
	 ul
	   [liurl "Grades, marks, follow-up"
	    ...
	    liurl "Live Meeting"
	      ("https://www.livemeeting.com/cc/ionis/join"
		  ^ "?id=MFWG42&role=present&pw=Aepiecae");
